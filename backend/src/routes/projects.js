...
router.get('/', requireAuth, async (req, res) => {
  try {
    ...
    res.json({
      ...
      data: projects,
      metrics: {
        totalProjects: refreshedDetailed.metrics.totalProjects,
        activeProjects: refreshedDetailed.metrics.ongoingProjects,
        verifiedProjects: refreshedDetailed.metrics.verifiedProjects,
        totalActivities: refreshedDetailed.metrics.totalActivities,
        totalEvidence: refreshedDetailed.metrics.totalEvidence,
        portfolioStrength: refreshedDetailed.metrics.portfolioStrength,
        verifiedCommits: 142,
