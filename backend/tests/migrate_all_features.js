...
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres.jokcbrqfnbrqgocwboli:Bannari@1234@aws-0-ap-south-1.pooler.supabase.com:6543/postgres?pgbouncer=true';
