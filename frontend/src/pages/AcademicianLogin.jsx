...
export default function AcademicianLogin({ onLoginSuccess, onBackToRoles, onNavigateToOtp, onNavigateToForgot }) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const res = await fetch('http://localhost:5000/api/auth/register/faculty', {
        method: 'POST',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '11.5px', fontWeight: 700, color: '#a5b4fc', textTransform: 'uppercase', letterSpacing: '0.03em' }}>
